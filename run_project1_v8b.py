# -*- coding: utf-8 -*-
"""v8b — субтитры и музыка из v8 уже готовы (не трогаем), только оверлеи
(теперь с retry в suggest_overlays_llm) + финальный рендер."""
import json
import time
...
print(f"=== 1. Оверлеи (LLM-фолбэк с повтором) [{elapsed()}] ===")
