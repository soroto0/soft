# -*- coding: utf-8 -*-
"""v10 — финальная проверка: слоёная раскладка оверлеев (гарантированно,
локально) + LLM-текст поверх где совпало. Та же раскадровка/музыка что в
v8/v9, ноль новых Veo-запросов. Пишет в output_final_v10.mp4."""
import json
import time
